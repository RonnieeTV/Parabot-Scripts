...
@ScriptManifest(author = "Tommyb603", category = Category.COMBAT, description = "Kills Crabs on Battlescape", name = "BSCrabber", servers = { "377 only" }, version = 1.0)
public final class BSCrabber extends Script implements Paintable {
	...
	public class Attack implements Strategy {
		...
		public boolean activate() {
			Player me = Players.getMyPlayer();
			return !me.isInCombat() || Inventory.getCount(SHARK) > 0;
		}
